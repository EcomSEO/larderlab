export function AuthorBio() {
  return (
    <section className="mt-12 p-6 border border-ink/10 rounded-lg bg-white/50">
      <h3 className="font-serif text-lg text-ink mb-2">
        About The Larderlab Team
      </h3>
      <p className="text-charcoal/80 leading-relaxed text-[15px]">
        The Larderlab Team is a small group of researchers and writers
