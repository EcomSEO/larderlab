...
export const USDA_LEDGER: Record<string, UsdaEntry> = {
  ...
  "white-rice-cooked": {
    ...
    macros: { calories: 205, protein: 4.3, fat: 0.4, carbs: 45, fiber: 0.6, sugar: 0.1 },
    micros: { sodium: 604, iron: 1.9, potassium: 55 },
    sourceUrl: fdcUrl(168878),
    lastVerified: "2026-04-29",
  },
  "olive-oil-extra-virgin": {
    ...
    servingSizeG: 14,
    servingDescription: "1 tablespoon (~14 g)",
    macros: { calories: 119, protein: 0, fat: 13.5, carbs: 0, fiber: 0, sugar: 0 },
    sourceUrl: fdcUrl(171413),
    lastVerified: "2026-04-29",
    substitutionNote:
      "FDC entry is generic 'olive oil, salad or cooking'; extra-virgin is a sub-grade with the same macro profile but a higher polyphenol content not captured in the FDC nutrient panel.",
  },
  "lentils-cooked": {
    fdcId: 172420,
