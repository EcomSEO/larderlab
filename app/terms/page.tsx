...
export const metadata: Metadata = pageMetadata({
  ...
  description: "The terms that govern your use of Larderlab.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <TrustPageTemplate title="Terms of Service">
      ...
      <p>
        By accessing larderlab.com (&ldquo;the Site&rdquo;), you agree to
        these Terms. If you don&apos;t agree, don&apos;t use the Site.
      </p>

      <h2>1. The Site is informational</h2>
      <p>
        Larderlab publishes editorial content about non-toxic living,
      ...
      <p>
        ...
        Larderlab or licensed to us. You may share excerpts with
      ...
      <p>
        To the maximum extent permitted by law, Larderlab is not liable
      ...
      <h2>10. Contact</h2>
      <p>Questions about these Terms? Email hello@larderlab.com.</p>
    </TrustPageTemplate>
  );
}
